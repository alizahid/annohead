...
export type ProductCategories = Awaited<ReturnType<typeof products.categories>>
export type ProductStorageLevels = Awaited<
  ReturnType<typeof products.storageLevels>
>
